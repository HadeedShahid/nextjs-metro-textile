        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e4e4e7;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="padding-top:24px;">
                    <p style="margin:0 0 8px;color:#71717a;font-size:12px;text-transform:uppercase;letter-spacing:0.5px;">Project Requirements</p>
          ...
          <tr>
            <td style="padding:0 40px 32px;">
              <a href="mailto:${email}?subject=Your Quote Request — ${COMPANY_NAME}"
          ...
          <tr>
            <td style="background:#f9f9fb;padding:20px 40px;border-top:1px solid #e4e4e7;">
              <p style="margin:0;color:#a1a1aa;font-size:12px;">
                This quote request was submitted via the ${COMPANY_NAME} website.
              </p>
            </td>
          </tr>
